    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          <img src={ALPHA_LOGO_URL} alt="Alpha Store" className="w-24 h-24 mx-auto mb-6" />
          <h1 className="text-5xl font-bold mb-4 text-foreground">ALPHA STORE</h1>
        ...
        <div className="mt-8 p-4 bg-card rounded-lg border border-border">
          <h3 className="font-bold text-foreground mb-2">Why Discord?</h3>
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>✓ Secure authentication</li>
            <li>✓ One-click login</li>
            <li>✓ Manage your Discord profile</li>
          </ul>
        </div>
      </div>
    </div>
